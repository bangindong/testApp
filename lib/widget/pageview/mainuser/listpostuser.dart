...
import 'package:socialapp/blocs/post.main.user.dart';
import 'package:socialapp/page/comment.dart';
import 'package:socialapp/static/static.dart';
import 'dart:math' as math;
import 'package:user_repository/user_repository.dart';

class PostsListUser extends StatefulWidget {
  @override
  _PostsListUserState createState() => _PostsListUserState();
}

class _PostsListUserState extends State<PostsListUser>
    with AutomaticKeepAliveClientMixin {
  @override
  Widget build(BuildContext context) {
    final PostUserBloc postBloc =
        Provider.of<PostUserBloc>(context, listen: false);
    return Consumer<MainUserBloc>(
      builder: (context, post, child) {
        if (Static.mainUser.userId != null) {
          postBloc.getPost();
        }
        return Expanded(
          child: Material(
            child: RefreshIndicator(
              ...
              onRefresh: () async {
                if (Static.mainUser != null && Static.mainUser.userId != null) {
                  postBloc.getPost();
                }
              },
            ),
